  <nav class="navbar-dark bg-dark navbar-top-fixed">
  <div id="menu" class="${layout} navbar navbar-expand-lg">
    ...
    <div class="collapse navbar-collapse" id="navbarColor01">
      ...
      <form class="form-inline">
        ...
        <button class="btn btn-outline-info my-2 my-sm-0" type="submit"><fmt:message key="label.rechercher" /></button>
      </form>
    </div>
    </div>
  </nav>
