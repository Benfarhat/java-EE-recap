...
<html lang="en">
  <head>
    ...
    <title>Bootstrap template with some angular</title>
...
<body>
  ...
  <nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
    <a class="navbar-brand" href="#">Toba AC&sup2;</a>
    ...
    <div class="collapse navbar-collapse" id="navbarsExampleDefault">
      <ul class="navbar-nav mr-auto">
        <li class="nav-item active">
          <a class="nav-link" href="#">Identity Management</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="#">Badge Printing</a>
        </li>
      </ul>
